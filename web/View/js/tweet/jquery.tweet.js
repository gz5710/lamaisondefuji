        ...
        this.each(function() {
          returning.push(this.replace(regexp,
                                      function(match) {
                                        ...
                                        return "<a href=../../web/js/tweet//""+url+"/">"+match+"</a>";
                                      }));
        });
        return $(returning);
      },
      ...
      $(widget).bind("load", function(){
        $.getJSON(build_url(), function(data){
          ...
          var tweets = $.map(data.results || data, function(item){
            ...
            var user = '<a class="tweet_user" href="../../web/js/tweet/'+user_url+'">'+screen_name+'</a>';
            var join = ((s.join_text) ? ('<span class="tweet_join"> '+join_text+' </span>') : ' ');
            var avatar = (avatar_size ?
                          ('<a class="tweet_avatar" href="../../web/js/tweet/'+user_url+'"><img src="../../web/js/tweet/'+avatar_url+
                           '" height="'+avatar_size+'" width="'+avatar_size+
                           '" alt="'+screen_name+'\'s avatar" title="'+screen_name+'\'s avatar" border="0"/></a>') : '');
            var time = '<span class="tweet_time"><a href="../../web/js/tweet/'+tweet_url+'" title="view tweet on twitter">'+tweet_relative_time+'</a></span>';
